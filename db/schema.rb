...
ActiveRecord::Schema.define(version: 2019_01_03_121253) do
  ...
  create_table "migrations", force: :cascade do |t|
    t.string "add_category_id_to_university"
  ...
  create_table "universities", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.integer "category_id"
    t.string "uni_image_file_name"
    t.string "uni_image_content_type"
    t.bigint "uni_image_file_size"
    t.datetime "uni_image_updated_at"
  end
